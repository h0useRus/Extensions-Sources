...
// Src: https://github.com/aspnet/Common/blob/dev/shared/Microsoft.Extensions.ObjectMethodExecutor.Sources/ObjectMethodExecutorFSharpSupport.cs
...
namespace NSW.Extensions.Internal
{
    ...
    internal static class ObjectMethodExecutorFSharpSupport
    {
            ...
            out Type? awaitableType)
        {
            ...
            // };
            if (_fsharpAsyncStartAsTaskGenericMethod is not null)
            {
                ...
                if (_fsharpOptionOfTaskCreationOptionsNoneProperty is not null &&
                    _fsharpOptionOfCancellationTokenNoneProperty is not null)
                {
        ...
        {
            if (possibleFSharpAsyncGenericType == null) return false;
