...
// Src: https://github.com/aspnet/Common/blob/dev/shared/Microsoft.Extensions.ObjectMethodExecutor.Sources/ObjectMethodExecutor.cs
...
namespace NSW.Extensions.Internal
{
    internal class ObjectMethodExecutor
    {
        ...
        public ObjectMethodExecutorAwaitable ExecuteAsync(object target, object[] parameters) => _executorAsync!.Invoke(target, parameters)!;
