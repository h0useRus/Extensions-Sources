...
// Src: https://github.com/aspnet/Common/blob/dev/shared/Microsoft.Extensions.ObjectMethodExecutor.Sources/CoercedAwaitableInfo.cs
using System;
...
namespace NSW.Extensions.Internal
{
    internal readonly struct CoercedAwaitableInfo
    {
        ...
        public static bool IsTypeAwaitable(Type type, out CoercedAwaitableInfo info)
        {
            ...
            {
                if (coercerResultType != null && AwaitableInfo.IsTypeAwaitable(coercerResultType, out var coercedAwaitableInfo))
                {
